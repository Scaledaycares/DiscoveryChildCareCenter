...
function startConversation() {
    fetch('https://chatbot-for-discovery-child-care-center.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-discovery-child-care-center.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyXKC3iHsCtLzd2XkpbrcSLN1m6o_5Szbsd-ED-PWXfZgl-TXGG1q-EcKEqq8YCNZevUg/exec';
